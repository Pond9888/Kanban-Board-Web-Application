export default function CalendarPage() {
  return (
    <ComingSoon
      title="Calendar"
      breadcrumb="Calendar"
      description="Visualize your tasks and deadlines on a calendar. Drag to reschedule, set reminders, and see your team's workload at a glance."
      iconPath="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"
      gradient="from-blue-500 to-cyan-600"
      features={['Monthly & weekly views', 'Deadline tracking', 'Team schedule overlay', 'AI-suggested scheduling']}
    />
  )
}
